...
public class LengthTest {
    ...
    public void should_2_feet_equals_2_feet() {
        Length result = new Length(2, Length.F).as(Length.F);

        assertThat(result.getValue(), is(2.0));
        assertThat(result.getUnit(), is(Length.F));
    }
    ...
    public void should_1_foot_equals_12_inches() {
        Length result = new Length(1, Length.F).as(Length.INCH);
    ...
    public void should_3_foot_equals_1_yard() {
        Length result = new Length(3, Length.F).as(Length.YARD);
    ...
    public void should_1_yard_equals_3_feet() {
        Length result = new Length(1, Length.YARD).as(Length.F);
    ...
    public void should_12_inches_equals_1_foot() {
        Length result = new Length(12, Length.INCH).as(Length.F);
